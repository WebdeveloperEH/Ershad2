$(function () {
  ...
  $(".colors").on("click", function () {
    ...
    if (dataValue != undefined) {
      $("link[href='assets/css/style.css']").after(
        '<link rel="stylesheet" href="assets/css/color-' + dataValue + '.css">'
      );
  ...
  $(".cross").on("click", function () {
    ...
    $("link[href='assets/css/responsive.css']").before(
      '<link rel="stylesheet" class="shape-css" href="assets/css/shape-2.css">'
    );
  });
  $(".angle").on("click", function () {
    $(".shape-css").remove();
    $("link[href='assets/css/responsive.css']").before(
      '<link rel="stylesheet" class="shape-css" href="assets/css/shape-3.css">'
    );
  });
  ...
  $(".dark").on("click", function () {
    $(".dark-mode").remove();
    $("link[href='assets/css/responsive.css']").before(
      '<link rel="stylesheet" class="dark-mode" href="assets/css/dark.css">'
    );
  });
